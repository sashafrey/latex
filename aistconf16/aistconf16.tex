...
In addition to plain text many collections has other data,
...
The algorithm supports all main features of ARTM models,
including multi-modality, ability to add custom regularizers and combine them with 
built-in regularizers to produce models that satisfy user requirements.
This makes the algorithm flexible and allows it to cover
a much wider class of topic models
than just Latent Dirichlet Allocation.
...
to tweak batch size, number of inner loops per document, and other technical parameters.
