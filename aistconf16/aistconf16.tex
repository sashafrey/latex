...
Basic idea is to trigger asynchronous execution of the \kw{Offline ARTM} algorithm
...
in the \kw{DetAsync} algorithm,
which produces a deterministic result from run to run
