...
\end{tabular}
\caption{Gantt chart for the \kw{Offline ARTM} (Algorithm \ref{alg:OfflineARTM})} \label{fig:gantt:OfflineARTM}
\end{figure}
...
\begin{figure}[t]
	...
	\begin{tabular}{c}
		...
		\includegraphics[scale=1]{plots/legend_online.pdf}
	\end{tabular}
	\caption{Gantt chart for async online algorithm} \label{fig:gantt:DetAsyncARTM}
\end{figure}
