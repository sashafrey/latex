function [bound, worstBound] = asymptoticScUpperBound(algs, sources, L, ell)
    nAlgs = algs.Count;
...
%         end
    ...
    [bound, worstBound] = asymtoticScUpperBound_inner(errMatrix, scMatrix, ell, L);
end

function [ expectation , worst ] = asymtoticScUpperBound_inner( A, Connect, l, L )
