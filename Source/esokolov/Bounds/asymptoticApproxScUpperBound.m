function [bound, worstBound] = asymptoticApproxScUpperBound(algs, sources, L, ell)
    nAlgs = algs.Count;
    ...
    [bound, worstBound] = asymptoticApproxScUpperBound_inner(errMatrix, scMatrix, ell, L);
end

function [ expectation , worst ] = asymptoticApproxScUpperBound_inner( A, Connect, l, L )
