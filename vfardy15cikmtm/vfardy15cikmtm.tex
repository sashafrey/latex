...
where words form the elements of only one modality.
...
reduce correlation between topics in terms of the columns of the $\Phi$~matrix.
...
In terms of topic selection the new regularizer has several advantages over
Hierarchical Dirichlet Process~\cite{teh06hierarchical}:
it gives a~more stable number of~topics, takes less time to execute,
and has ability to combine it with other topic models via additive regularization.
...
sparsity of $\Phi$ and $\Theta$ matrices, and
