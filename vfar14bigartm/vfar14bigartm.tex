...
\begin{table}[t]
	\caption{
        ...
        \emph{Train time} is time for model training,
        \emph{inference time} is time for calculation of $\theta_d$ of $100\,000$ held-out documents,
	...
	Gensim LDA & 1 & 369 min & 395 sec & 4161 (mean) / 4213 (map) \\
	Vowpal Wabbit LDA & 1 & 73 min & 120 sec & 4108 (mean) / 4061 (map) \\
	\hline
	BigARTM +smoothing & 4 & 13 min & 33 sec & 4061 \\
	Gensim LDA-Multicore & 4 & 60 min & 222 sec & 4111 (mean) / 4055 (map) \\	
	\hline
	BigARTM +smoothing & 8 & 8 min & 24 sec & 4304 \\
	Gensim LDA-Multicore & 8 & 57 min & 224 sec & 4455 (mean) / 4379 (map) \\
	\hline
	\end{tabular}
\end{table}
...
\input{plot_kernel}
\end{tabular}
\caption{Comparison of LDA (thin) and ARTM (bold) models. The number of processed documents is along X~axis.}
\label{fig:comparison_plot}
\end{figure}

Table \ref{tab:model_comparison} compares the results of additive combination of regularizers (ARTM) and usual LDA model.
