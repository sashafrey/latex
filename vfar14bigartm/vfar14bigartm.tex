...
\begin{align*}
	\theta^{\mathrm{mean}}_{td} &\propto \gamma_{td}, &
    \phi^{\mathrm{mean}}_{wt} &\propto \lambda_{wt};
\\
	\theta^{\mathrm{mode}}_{td} &\propto \max\{\gamma_{td}-1,0\}, &
    \phi^{\mathrm{mode}}_{wt} &\propto \max\{\lambda_{wt}-1,0\}.
\end{align*}
